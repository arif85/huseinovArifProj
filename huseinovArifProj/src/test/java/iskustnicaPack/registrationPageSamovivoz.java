...
public class RegistrationPageSamovivoz {
    ...
    public RegistrationPageSamovivoz(String familia, String imia, String otchesvto, String den, String mesiac,
                                     String god, String email, String pass, String repass, String cellphone) {
        super();
        this.familia = familia;
        this.imia = imia;
        this.otchesvto = otchesvto;
        this.den = den;
        this.mesiac = mesiac;
        this.god = god;
        this.email = email;
    ...
    public void registrationPageSamovivoz() {
        ...
        myApp.registrationPageValueOne.InputTextIntoFieldOtchestvo(otchesvto);
